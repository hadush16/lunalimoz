    ...
    <div className="p-4 sm:p-8 md:p-10 space-y-10 pb-20">
      <header className="space-y-4">
        <h1 className="font-serif text-3xl md:text-5xl font-black italic uppercase text-slate-900 dark:text-white tracking-tight">
          System <span className="text-amber-600 dark:text-gold">Intelligence</span>
        </h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, idx) => (
          <div key={idx} className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 p-6 relative overflow-hidden group hover:border-amber-500 dark:hover:border-gold/30 transition-all duration-300 shadow-sm">
            <div className="absolute top-0 left-0 w-1 h-full bg-amber-500 dark:bg-gold opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="flex justify-between items-start mb-4">
              <stat.icon className="h-6 w-6 text-amber-600 dark:text-gold" />
            </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="col-span-1 lg:col-span-2 bg-white dark:bg-neutral-900 border border-slate-200 dark:border-neutral-800 p-6 flex flex-col h-[400px]">
          <h2 className="text-amber-600 dark:text-gold text-[10px] font-black uppercase tracking-[0.3em] mb-6 flex items-center justify-between">
            Revenue Trend
